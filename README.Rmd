...
> **IMPORTANT NOTE**
> For the active subnetwork search component to work, the user must have [Java  (>= 8.0)](https://www.java.com/) installed, and the path/to/java must be in the PATH environment variable.
