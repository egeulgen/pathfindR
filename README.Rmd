...
This workflow takes in a data frame consisting of Gene symbols, log-fold-change (optional) and associated p values.

```{r example_input, echo=FALSE}
knitr::kable(RA_input[1:4, ])
```
