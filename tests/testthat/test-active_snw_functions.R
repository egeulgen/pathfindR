...
test_that("Active snw search function returns list object", {
  ...
  expect_message(
    snw_list <- active_snw_search(input_df1, pin_path),
  ...
  expect_message(
    snw_list <- active_snw_search(input_df2, pin_path),
  ...
  expect_message(
    snw_list <- active_snw_search(input_df2,
      pin_path,
