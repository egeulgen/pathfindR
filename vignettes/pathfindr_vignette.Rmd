...
The function also creates an HTML report `results.html` that is saved in the current working directory. This report contains links to two other HTML files:
