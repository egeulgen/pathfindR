...
In essence, this argument is treated as a path so it can be used to create the output directory anwyhere. For example, to create the directory `"my_dir"` under `"~/Desktop"` and run the analysis there, you may run:
