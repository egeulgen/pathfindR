...
By default, `run_pathfindR()` creates a temporary directory for writing the output files, i.e. active subnetwork search results. To set the output directory, use `output_dir`:
