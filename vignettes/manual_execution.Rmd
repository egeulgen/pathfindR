...
The `pin_name_path` argument in all functions can be one of “Biogrid”, “GeneMania”, “IntAct”, “KEGG” or it can be the path to a custom PIN file provided by the user.
