...
## filter using combined_score cut-off value of 400
...
|:------------------|:------------------|
|ENSMUSP00000000001 |ENSMUSP00000113105 |
...
Because we used a very strict cut-off (logFC > 2 + FDR < 0.05), there were only 9 enriched KEGG pathways. However, the pathways identified here significantly related to the pathways identified in the original publication by Wang et al.[^1].
