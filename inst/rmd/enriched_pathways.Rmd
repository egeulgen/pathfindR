---
title: '`r logo_path <- system.file("help/figures/logo.png", package = "pathfindR"); knitr::opts_chunk$set(out.width="15%"); knitr::include_graphics(logo_path)` pathfindR - All Enriched Pathways - `r params$gset`' 
