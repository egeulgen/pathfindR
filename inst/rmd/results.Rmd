---
title: '`r logo_path <- system.file("vignettes", "logo.png", package = "pathfindR"); knitr::opts_chunk$set(out.width="15%"); knitr::include_graphics(logo_path)` pathfindR - Results'
