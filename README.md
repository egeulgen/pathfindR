...
[![R-CMD-check](https://github.com/egeulgen/pathfindR/actions/workflows/check-standard.yaml/badge.svg)](https://github.com/egeulgen/pathfindR/actions/workflows/R-CMD-check.yaml)
[![Codecov test
