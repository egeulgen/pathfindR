...
active_snw_enrichment_wrapper <- function(input_processed, pin_path, gset_list, enrichment_threshold,
                                          ...
                                          sig_gene_thr = 0.02, sa_initial_temp = 1, saTemp1 = 0.01, saIter = 10000, gaPop = 400,
  ...
  if (iterations == 1) {
    combined_res <- single_iter_wrapper(
      ...
      gene_init_prob, sa_initial_temp, saTemp1, saIter, gaPop, gaIter, gaThread, gaCrossover,
    ...
    if (!disable_parallel) {
      ...
      combined_res <- foreach::foreach(
        ...
        single_iter_wrapper(
          ...
          gene_init_prob, sa_initial_temp, saTemp1, saIter, gaPop, gaIter, gaThread,
      ...
      for (i in 1:iterations) {
        current_res <- single_iter_wrapper(
          ...
          sa_initial_temp, saTemp1, saIter, gaPop, gaIter, gaThread, gaCrossover,
...
single_iter_wrapper <- function(i = NULL, dirs, input_processed, pin_path, score_quan_thr,
                                ...
                                sa_initial_temp, saTemp1, saIter, gaPop, gaIter, gaThread, gaCrossover, gaMut, grMaxDepth,
