...
#' @param num_terms Number of top enriched terms to use while creating the heatmap. Set to \code{NULL} to use
#'  all enriched terms (default = 10, i.e. heatmap of top 10 terms)
